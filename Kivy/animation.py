...
class TestApp(App):
    ...
    def animate(self, instance):
        ...
        animation += Animation(pos=(0, 500), t='out_bounce')
        animation += Animation(pos=(500, 500), t='out_bounce')
        animation += Animation(pos=(500, 0), t='out_bounce')
        animation &= Animation(size=(200, 200))
    ...
    def build(self):
        ...
        button = Button(size_hint=(None, None), text='Click Here',
